...
if __name__ == "__main__":
    ...
    ap.add_argument("--out_dir", default="outputs/04_returns/2025")
    ap.add_argument("--preds_win", default="outputs/03_train/binary/tables/preds_win_2025_eval.csv")
    ap.add_argument("--preds_place", default="outputs/03_train/binary/tables/preds_place_2025_eval.csv")
    ap.add_argument("--preds_rank", default="outputs/03_train/rank/tables/preds_rank_2025_eval.csv")
